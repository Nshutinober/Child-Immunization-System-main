...
<head>
    ...
    <title>Mbarara  Referral | Admin</title>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Vaccines', 'NO. OF CHILDREN', 'NO. OF VACCINATED '],
          <?php
     ...
     <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          [' 2024',<?php echo $complete; ?> ,<?php echo $Incomplete; ?>],
        ]);
...
<body>
       ...
       <div class="container">
  <!-- First chart -->
  <div id="columnchart_material" style="width: 75%;"></div>
  <br>
  <hr/>
  <!-- Second chart -->
  <div id="total_of_vaccinated" style="width: 75%;"></div>
</div>
<style>
  .container{
    height: 500px;
