...
<body>
    ...
    <nav>
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<center><h3>Schedule for " . $childFN . " " . $childLN . "</h3></center><br/>";
      ...
      <thead style="line-height: 40px">
                <th style="width: 30%; text-align: center;">Time for Injection</th>
      ...
      <tbody>
        ...
        <center>
        <hr style="border: 1.5px solid darkcyan; width: 75%;"></center><br>
