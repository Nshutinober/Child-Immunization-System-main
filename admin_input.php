...
<style type="text/css">
  ...
  justify-content: space-around; /* This will space the content evenly */
...
.container > * {
  flex: 0 1 calc(50% - 20px); /* Two items per row with some spacing between them */
  margin: 10px;
}
...
<div class="container">
  <p>Fill this up for the new vaccine to be added.</p>
  <!-- Vaccine with Doses -->
...
<div class="container">
  <p>Input here the name of vaccinator</p>
  <!-- Vaccinator -->
  <form action="#" method="post">
    <div class="mb-3">
